...
public class Map1 extends Map implements IMap {
	...
	public Map1(TheDoorMaze world, int mapWidth, int mapHeight, String background) {
		...
		this.objects.add(new Door(this.world, 700, 130, "src/main/java/nl/han/ica/TheDoorMaze/media/doors/Toilet.png",
				"2", "BathRoom", true));
		...
		this.objects
				.add(new Person(world, 400, 200, "src/main/java/nl/han/ica/TheDoorMaze/media/objects/G001.png", "Chris",
						new String[] { "Veel succes op je date broer, d'r insta looks boem spang,",
								"net zoals team boem spang, maar dan minder spang.",
								"Oja de code van Ricky's kluis is 1234 dacht ik." }));
